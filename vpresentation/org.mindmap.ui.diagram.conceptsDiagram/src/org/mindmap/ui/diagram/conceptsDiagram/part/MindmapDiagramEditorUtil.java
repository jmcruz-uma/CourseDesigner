...
public class MindmapDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							org.mindmap.ui.diagram.conceptsDiagram.part.Messages.MindmapDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									org.mindmap.ui.diagram.conceptsDiagram.part.Messages.MindmapDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = org.mindmap.ui.diagram.conceptsDiagram.part.ConceptsMindmapDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor
				.beginTask(
						org.mindmap.ui.diagram.conceptsDiagram.part.Messages.MindmapDiagramEditorUtil_CreateDiagramProgressTask,
						3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				org.mindmap.ui.diagram.conceptsDiagram.part.Messages.MindmapDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				ConceptosDiagrama model = createInitialModel();
	 ...
	 * @generated
	 */
	private static ConceptosDiagrama createInitialModel() {
		return ModelFactory.eINSTANCE.createConceptosDiagrama();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(ConceptosDiagrama model,
			Resource resource) {
