...
public class MindmapValidationDecoratorProvider extends AbstractProvider
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof org.mindmap.ui.diagram.conceptsDiagram.part.MindmapDiagramEditor) {
	...
	public static class StatusDecorator extends AbstractDecorator {
		...
		public void refresh() {
			...
			org.mindmap.ui.diagram.conceptsDiagram.part.ValidationMarker foundMarker = null;
			org.mindmap.ui.diagram.conceptsDiagram.part.ValidationMarker[] markers = org.mindmap.ui.diagram.conceptsDiagram.part.ValidationMarker
			...
			for (int i = 0; i < markers.length; i++) {
				org.mindmap.ui.diagram.conceptsDiagram.part.ValidationMarker marker = markers[i];
