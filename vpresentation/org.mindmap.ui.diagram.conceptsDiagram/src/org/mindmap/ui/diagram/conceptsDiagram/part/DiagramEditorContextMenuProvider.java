...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private org.mindmap.ui.diagram.conceptsDiagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new org.mindmap.ui.diagram.conceptsDiagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
