...
public class DiagramEditorActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void fillMenuBar(IMenuManager menu) {

		{
			IMenuManager menuX = new MenuManager(
					org.mindmap.ui.diagram.actividadDiagram.part.Messages.ApplicationMenuName_File,
		...
		{
			IMenuManager menuX = new MenuManager(
					org.mindmap.ui.diagram.actividadDiagram.part.Messages.ApplicationMenuName_Edit,
		...
		if (editorDescriptor == null) {
			MessageDialog
					.openError(
							...
							org.mindmap.ui.diagram.actividadDiagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorTitle,
							NLS.bind(
									org.mindmap.ui.diagram.actividadDiagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorMessage,
			...
			try {
				...
				MessageDialog
						.openError(
								workbenchWindow.getShell(),
								org.mindmap.ui.diagram.actividadDiagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultEditorOpenErrorTitle,
	...
	public static class NewDiagramAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			org.mindmap.ui.diagram.actividadDiagram.part.MindmapCreationWizard wizard = new org.mindmap.ui.diagram.actividadDiagram.part.MindmapCreationWizard();
	...
	public static class AboutAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			MessageDialog
					.openInformation(
							getWindow().getShell(),
							org.mindmap.ui.diagram.actividadDiagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogTitle,
							org.mindmap.ui.diagram.actividadDiagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogMessage);
		}
	}
