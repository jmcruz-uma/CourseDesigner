...
public class MindmapInitDiagramFileAction implements
	...
	public void run(IAction action) {
		TransactionalEditingDomain editingDomain = GMFEditingDomainFactory.INSTANCE
				.createEditingDomain();
		Resource resource = org.mindmap.ui.diagram.actividadDiagram.part.MindmapDiagramEditorUtil
				.openModel(
						getShell(),
						org.mindmap.ui.diagram.actividadDiagram.part.Messages.InitDiagramFile_OpenModelFileDialogTitle,
						editingDomain);
		if (resource == null || resource.getContents().isEmpty()) {
			return;
		}
		EObject diagramRoot = (EObject) resource.getContents().get(0);
		Wizard wizard = new org.mindmap.ui.diagram.actividadDiagram.part.MindmapNewDiagramFileWizard(
				resource.getURI(), diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS
				.bind(org.mindmap.ui.diagram.actividadDiagram.part.Messages.InitDiagramFile_WizardTitle,
