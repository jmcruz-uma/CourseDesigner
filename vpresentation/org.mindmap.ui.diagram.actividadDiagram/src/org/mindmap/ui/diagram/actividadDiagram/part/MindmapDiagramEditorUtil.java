...
public class MindmapDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							org.mindmap.ui.diagram.actividadDiagram.part.Messages.MindmapDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									org.mindmap.ui.diagram.actividadDiagram.part.Messages.MindmapDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = org.mindmap.ui.diagram.actividadDiagram.part.ActDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor
				.beginTask(
						org.mindmap.ui.diagram.actividadDiagram.part.Messages.MindmapDiagramEditorUtil_CreateDiagramProgressTask,
						3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				org.mindmap.ui.diagram.actividadDiagram.part.Messages.MindmapDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				ActividadDiagrama model = createInitialModel();
	 ...
	 * @generated
	 */
	private static ActividadDiagrama createInitialModel() {
		return ModelFactory.eINSTANCE.createActividadDiagrama();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(ActividadDiagrama model,
			Resource resource) {
