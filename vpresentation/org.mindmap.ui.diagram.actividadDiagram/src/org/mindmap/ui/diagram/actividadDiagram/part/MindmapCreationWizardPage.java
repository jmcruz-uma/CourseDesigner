...
public class MindmapCreationWizardPage
		extends
		org.mindmap.ui.diagram.actividadDiagram.application.WizardNewFileCreationPage {
	...
	protected boolean validatePage() {
		...
		if (extension != null
			...
			setErrorMessage(NLS
					.bind(org.mindmap.ui.diagram.actividadDiagram.part.Messages.MindmapCreationWizardPageExtensionError,
							extension));
			return false;
		}
		return true;
