...
public class WizardNewFileCreationPage extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		label.setText(org.mindmap.ui.diagram.actividadDiagram.part.Messages.WizardNewFileCreationPage_FileLabel);
		...
		button.setText(org.mindmap.ui.diagram.actividadDiagram.part.Messages.WizardNewFileCreationPage_BrowseButton);
		...
		button.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				dialog.setText(org.mindmap.ui.diagram.actividadDiagram.part.Messages.WizardNewFileCreationPage_SelectNewFileDialog);
	...
	protected boolean validatePage() {
		String fileName = fileNameEditor.getText().trim();
		if (fileName.length() == 0) {
			setErrorMessage(org.mindmap.ui.diagram.actividadDiagram.part.Messages.WizardNewFileCreationPage_EmptyFileNameError);
			return false;
		}
		if (!new Path("").isValidPath(fileName)) { //$NON-NLS-1$
			setErrorMessage(org.mindmap.ui.diagram.actividadDiagram.part.Messages.WizardNewFileCreationPage_InvalidFileNameError);
			return false;
		}
